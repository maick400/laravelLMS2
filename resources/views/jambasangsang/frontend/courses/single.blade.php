                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6">
                            <div class="course-features mt-30">
                                ...
                                <button type="button" class="btn btn-warning p-2 fw-bold" data-toggle="modal" data-target="#exampleModal">
                                  Suscribe
                                  </button>
                                    ...
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        <div class="modal-header">
                                          <h5 class="modal-title" id="exampleModalLabel">New Suscription</h5>
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>
                                        <div class="modal-body">
                                          ¿Are sure to suscribe to course "{{$course->name}}"?
                                          <br>
                                          <b>duración: </b> {{$course->duration}} days
                                        </div>
                                        <div class="modal-footer">
                                          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                          <a href="/Course/enroll/{{ $course->id }}" value="{{ $course->id }}"
                                          class="btn btn-warning p-2 fw-bold">@lang('Suscribe') ({{$course->price}}$)</a>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
