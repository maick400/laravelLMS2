                                ...
                                <form action="{{ route('lessons.store') }}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-6 mt-3">
                                            <label for="x_card_code" class="control-label mb-1">@lang('Category')</label>
                                            <div class="input-group">
                                                <select name="category" id="category" class="form-control">
                                                    <option value="">@lang('Select Category')</option>
                                                    <option value="PRC">@lang('Practic')</option>
                                                    <option value="TEO">@lang('Teory')</option>
                                                </select>
                                            </div>
                                            @error('category')
                                                <div class="help-block field-validation-valid alert alert-danger">
                                        ...
                                        <div class="col-12">
                                            <label for="x_card_code" class="control-label mb-1">@lang('Video')</label>

                                            <input class="form-control" id="video" name="video"></input>
                                            @error('video')
                                                <div class="help-block field-validation-valid alert alert-danger">
                                                    {{ $message }}</div>
                                            @enderror
