...
Route::get('/Courses/store/{course}', [FrontEndCourseController::class, 'enroll'])->name('Courses.enroll');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/courses/{slug}', [CourseController::class, 'show'])->name('courses.show');
    Route::get('/Course/enroll/{course}', [CourseController::class, 'suscribe'])->name('courses.suscribe');
    ...
    Route::post('/review/add', [ReviewController::class, 'store'])->name('reviews.store');
